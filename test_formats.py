...
def test_json_validation():
  ...
  "version": "1.0.0"
    ...
    print("  ✓ Passes validation" if result1.yaml_valid else "  ✗ Failed")
    print()
    ...
    print(
        ...
        if not result2.yaml_valid else "  ✗ Should have failed"
    )
    print()
...
<body><h1>Not Found</h1></body>
    ...
    _html_detected = result3.yaml_error == "HTML content returned instead of JSON"
    print(
        "  ✓ HTML detected" if _html_detected else "  ✗ HTML not detected"
    )
    print()
...
platforms:
  - web'''
    ...
    print("  ✓ Passes validation" if result4.yaml_valid else "  ✗ Failed")
    print()
